...
export class CodeMeta implements CodeMetaInterface {
	...
	fromObject(obj: {[key: string]: any}): boolean {
		...
		this.atContext = (obj['@context'] === undefined) ? 'https://doi.org/10.5063/schema/codemeta-2.0': obj['@context'];
		this.type = (obj['type'] === undefined) ? '' : obj['type'];
		this.applicationCategory = (obj['applicationCategory'] === undefined) ? '' : obj['applicationCategory'];
		...
		this.codeRepository = (obj['codeRepository'] === undefined) ? '' : obj['codeRepository'];
		this.dateCreated = (obj['dateCreated'] === undefined) ? '': obj['dateCreated'];
		this.dateModified = (obj['dateModified'] === undefined) ? '': obj['dateModified'];
		...
		this.operatingSystem = (obj['operatingSystem'] === undefined) ? '': obj['operatingSystem'];
		...
		this.relatedLink = (obj['relatedLink'] === undefined) ? '': obj['relatedLink'];
		this.runtimePlatform = (obj['runtimePlatform'] === undefined) ? '': obj['runtimePlatform'];
		...
		this.developmentStatus = (obj['developmentStatus'] === undefined) ? '': obj['developmentStatus'];
		this.issueTracker = (obj['issueTracker'] === undefined) ? '': obj['issueTracker'];
		this.downloadUrl = (obj['downloadUrl'] === undefined) ? '': obj['downloadUrl'];
		this.releaseNotes = (obj['releaseNotes'] === undefined) ? '': obj['releaseNotes'];
		this.referencePublication = (obj['referencePublication'] === undefined) ? '': obj['referencePublication'];
		this.isSourceCodeOf = (obj['isSourceCodeOf'] === undefined) ? '': obj['isSourceCodeOf'];
