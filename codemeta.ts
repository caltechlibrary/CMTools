...
export const CodeMetaTerms: AttributeType[] = [ 
  ...
  new AttributeType("programmingLanguage", "text_list", "The computer programming language."),
  new AttributeType("operatingSystem", "text_list", "Operating systems supported (Windows 7, OSX 10.6, Android 1.6)."),
